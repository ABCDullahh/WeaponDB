...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('pabrik.store') }}" method="POST">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="tahun_pabrik_dibuat" class="form-label">Tahun Pabrik Dibuat</label>
                        <input type="text" class="form-control" name="tahun_pabrik_dibuat" id="tahun_pabrik_dibuat">
